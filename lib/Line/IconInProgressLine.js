...
var IconInProgressLine = function (_Component) {
  _inherits(IconInProgressLine, _Component);

  function IconInProgressLine() {
    _classCallCheck(this, IconInProgressLine);

    return _possibleConstructorReturn(this, (IconInProgressLine.__proto__ || Object.getPrototypeOf(IconInProgressLine)).apply(this, arguments));
  }

  _createClass(IconInProgressLine, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        _SVGIcon2.default,
        _extends({}, this.props, {
          name: 'IconInProgressLine',
  ...
  return IconInProgressLine;
}(_react.Component);

exports.default = IconInProgressLine;