...
var _cleanSVG = require('../util/cleanSVG');

var _cleanSVG2 = _interopRequireDefault(_cleanSVG);
...
var InlineSVG = function (_React$Component) {
  ...
  _createClass(InlineSVG, [{
    ...
    value: function renderContent(children, src) {
      if (src) {
        return _react2.default.createElement('g', { role: 'presentation', dangerouslySetInnerHTML: { __html: (0, _cleanSVG2.default)(src) } });
      } else {
